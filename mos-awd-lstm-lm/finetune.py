...
parser.add_argument('--final_switch', type=int, default=10000,
                     help='switch to not use advsoft to get stable result')
...
model.dropoutl = args.dropoutl
model.dropouth = args.dropouth
model.dropouti = args.dropouti
model.final_switch = args.final_switch
if args.cuda:
    if args.single_gpu:
...
def train(epoch=0):
    ...
    if args.partial:
        ...
        train_data = train_data_unshuffled
    ...
    while i < train_data.size(0) - 1 - 1:
        ...
        while start < args.batch_size:
            ...
            log_prob, hidden[s_id], rnn_hs, dropped_rnn_hs = parallel_model(cur_data, hidden[s_id], return_h=True, targets=cur_targets, epoch=epoch)
